...
public class Preprocessor {
  ...
  public static void main(String[] args) {
    String[] words = Preprocessor.preprocessing("Travelling to Europe with a budget of 20k");
  ...
  public static String[] preprocessing(String searchQuery) {
    ...
    String[] stopWords = { "a", "able", "about", "above", "abst", "accordance", "according", "accordingly", "across",
        ...
        "briefly", "but", "by", "c", "ca", "came", "can", "cannot", "can't", "cause", "causes", "certain", "certainly",
        "co", "com", "come", "comes", "contain", "containing", "contains", "could", "couldnt", "d", "date", "did",
        "didn't", "different", "do", "does", "doesn't", "doing", "done", "don't", "down", "downwards", "due", "during",
        ...
        "otherwise", "ought", "our", "ours", "ourselves", "out", "outside", "over", "overall", "owing", "own", "p",
        ...
        "seems", "seen", "self", "selves", "sent", "seven", "several", "shall", "she", "shed", "she'll", "shes",
        ...
        "sufficiently", "suggest", "sup", "sure	t", "take", "taken", "taking", "tell", "tends", "th", "than", "thank",
        "thanks", "thanx", "that", "that'll", "thats", "that've", "the", "their", "theirs", "them", "themselves",
        "then", "thence", "there", "thereafter", "thereby", "thered", "therefore", "therein", "there'll", "thereof",
        "therere", "theres", "thereto", "thereupon", "there've", "these", "they", "theyd", "they'll", "theyre",
        "they've", "think", "this", "those", "thou", "though", "thoughh", "thousand", "throug", "through", "throughout",
        "thru", "thus", "til", "tip", "to", "together", "too", "took", "toward", "towards", "tried", "tries", "truly",
        "try", "trying", "ts", "twice", "two", "u", "un", "under", "unfortunately", "unless", "unlike", "unlikely",
        "until", "unto", "up", "upon", "ups", "us", "use", "used", "useful", "usefully", "usefulness", "uses", "using",
        "usually", "v", "value", "various", "'ve", "very", "via", "viz", "vol", "vols", "vs", "w", "want", "wants",
        "was", "wasnt", "way", "we", "wed", "welcome", "we'll", "went", "were", "werent", "we've", "what", "whatever",
    ...
    // List<String> nameList = new ArrayList<>(Arrays.asList(stopWords));
    List<String> searchQ = new ArrayList<>();
    for (int i = 0; i < words.length; i++) {

      boolean IamNotAStopWord = true;
      for (int j = 0; j < stopWords.length; j++) {
        if (words[i].equals(stopWords[j])) {
          IamNotAStopWord = false;
          break;
        }
      }
      if (IamNotAStopWord) {
    ...
    String[] finalQuery = new String[searchQ.size()];
    for (int i = 0; i < searchQ.size(); i++) {
      finalQuery[i] = stemTerm(searchQ.get(i));
    }
    return finalQuery;
  }
}
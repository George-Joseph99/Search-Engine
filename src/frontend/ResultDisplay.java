...
public class ResultDisplay {
    ...
    public static void displayDocuments(List<RetrievedDocument> searchResults, double time) {
        try {
            fw = new FileWriter(Constants.HTML_FILENAME,false);
    ...
    private static void displayResult(int index, RetrievedDocument result) throws IOException {
        String desc;
        if(result.body.length() > 60) {
            desc = result.body.substring(0, 60);
        }
        else
        {
            desc = result.body;
        ...
        String str1 = "<div class=\""+ Constants.NUMBER_TO_INDEX[index] +"_result\">\n" +
